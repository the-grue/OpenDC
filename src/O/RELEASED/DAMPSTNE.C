/*  Dhampsstone benchmark --- Computer Language magazine Feb 86 */
/*  45 seconds using DeSmet ver. 2.51 with hard disk, V20 chip  */
...
char *b1, *b2;{
   ...
   for(i = 0, j = 0; i < SMALL; ++i){
	...
	mstrcpy(b2, "0123456789abcdee");	/* Different string */
	j += mstrcmp(b1, b2);
   }
   return(j);
}
